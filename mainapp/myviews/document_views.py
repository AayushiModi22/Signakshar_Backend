...
def schedule_sequence_email(data):
    ...
    try:
        ...
        reminder_datetime_pm = reminder_datetime_pm.replace(hour=15, minute=5, second=0)
        ...
        reminder_datetime_am = reminder_datetime_am.replace(hour=16, minute=2, second=0)
