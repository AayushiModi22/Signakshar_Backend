            ...
            if doc.req_type == "S":
                ...
                if email_obj and email_obj.status == 'sent':
                    ...
                    if next_pending_email:
                        ...
                        schedule_sequence_email({"email": next_pending_email.emails, "reminderDays": doc.reminderDays, "scheduledDate": doc.expirationDateTime, "doc_id": doc_id, "title": doc.email_title, "message": message,"text_content":text_content,"html_content":html_content})
                ...
                if email_obj and email_obj.status == 'sent':
                    ...
                    for data in next_pending_email:
                        ...
                        schedule_sequence_email({"email": data.emails, "reminderDays": doc.reminderDays, "scheduledDate": doc.expirationDateTime, "doc_id": doc_id, "title": doc.email_title, "message": message,"text_content":text_content,"html_content":html_content})
    ...
    try:
        for email_message in email_messages:
            ...
            try:
                ...
                schedule_sequence_email({"email":recipient_email,"reminderDays":doc.reminderDays,"scheduledDate":doc.expirationDateTime,"doc_id":doc.id,"title":subject, "message":message,"text_content":text_content,"html_content":html_content})
...
def schedule_sequence_email(data):
    try:
        ...
        reminder_datetime_am = reminder_datetime_am.replace(hour=17, minute=57, second=0)
        print("===================5==========================")
        expiration_days = (scheduled_datetime - timezone.now()).days
        doc = DocumentTable.objects.get(pk=doc_id)
        print("===================6==========================")
