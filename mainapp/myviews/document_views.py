...
def schedule_sequence_email(data):
    ...
    try:
        ...
        reminder_datetime_pm = reminder_datetime_pm.replace(hour=16, minute=52, second=0)
        ...
        reminder_datetime_am = reminder_datetime_am.replace(hour=16, minute=59, second=0)
