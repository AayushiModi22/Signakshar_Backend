    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expirationDateTime', models.DateTimeField(default=datetime.datetime(2024, 8, 28, 11, 56, 36, 396699, tzinfo=datetime.timezone.utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Schedule_type', models.CharField(default='N', max_length=1)),
                ('last_modified_date_time', models.DateTimeField(default=django.utils.timezone.now)),
                ('expirationDateTime', models.DateTimeField(default=datetime.datetime(2024, 8, 28, 11, 56, 36, 381085, tzinfo=datetime.timezone.utc))),
                ...
                ('last_modified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='documents_last_modified', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
